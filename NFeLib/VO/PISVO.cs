...
{
    public class PISVO  : BaseVO
    {
        #region Campos
        private PISxxVO pis = null;
        #endregion Campos
        ...
        {
            return new List<string>(PISXML.grupo.CamposNo.Keys);
        }
        ...
        {
            return PISXML.grupo.CamposNo[nomeCampo].TamanhoEntrada;
        }
        ...
        {
            return PISXML.grupo.CamposNo[nomeCampo].TipoDado;
        }
