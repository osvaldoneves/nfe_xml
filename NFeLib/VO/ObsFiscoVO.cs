...
{
    public class ObsFiscoVO : BaseVO
    {
        #region Campos
        ...
        {
            return new List<string>(ObsFiscoXML.grupo.CamposNo.Keys);
        }
        ...
        {
            return ObsFiscoXML.grupo.CamposNo[nomeCampo].TamanhoEntrada;
        }
        ...
        {
            return ObsFiscoXML.grupo.CamposNo[nomeCampo].TipoDado;
        }
