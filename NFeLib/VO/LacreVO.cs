...
namespace OLNG.Bibliotecas.NFeLib.VO
{
    public class LacreVO  : BaseVO
    {
        ...
        {
            get { return this.nLacre; }
            set { this.nLacre = value; }
        }
        ...
        {
            return new List<string>(LacreXML.grupo.CamposNo.Keys);
        }
        ...
        {
            return LacreXML.grupo.CamposNo[nomeCampo].TamanhoEntrada;
        }
        ...
        {
            return LacreXML.grupo.CamposNo[nomeCampo].TipoDado;
        }
